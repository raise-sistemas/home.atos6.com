          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              <TextBody>
                ...
                transferidos de forma criptografada e armazenados em servidores
                cloud (em nuvem) fornecidos pela{" "}
                ...
                da Cloudinary). Além disso, utilizamos criptografia TLS 1.2 e
                TSL 1.3 de ponta a ponta e uma variedade de tecnologias e
                procedimentos de segurança para ajudar a proteger as informações
                dos Usuários Finais.{" "}
                <u>
                  <b>
              ...
              <TextBody>
                A forma de cadastro dos Usuários Finais, dados requeridos e a
                forma de tratamento destes dados serão determinados pela
                Organização controladora destes dados pessoais, ou seja, a quem
                compete as decisões referentes ao tratamento de dados pessoais.
                A<b> ATOS6</b>, como operadora de dados, apenas é a ferramenta
                para esta gestão.
              </TextBody>
              <br />
              <TextBody size="bold">
              ...
              <TextBody>
                A <b>ATOS6</b> é operadora do tratamento de dados pessoais dos
                Usuários Finais que acessam o ambiente digital por meio da
                plataforma. A<b> ATOS6</b> apenas oferece ferramentas de gestão
                para a Organização controladora e realiza todo o tratamento de
                dados com base nas decisões da Organização controladora. No caso
                descrito, estas Organizações são controladoras do tratamento de
                dados pessoais dos Usuários Finais que acessam as ferramentas de
                gestão, por meio da plataforma da <b>ATOS6</b>.
                <br />
                <br />A <b>ATOS6</b> não realiza qualquer tipo de tratamento dos
                dados inseridos pelos Usuários Finais nas ferramentas de gestão
                utilizadas pela Organização controladora para finalidades
                próprias.
                <br />
                <br />A <b>ATOS6</b>, em algumas situações, pode ser considerada
                controladora do tratamento, principalmente no que diz respeito
                aos dados coletados para prestar o serviço à Organização
                controladora, elaborar os contratos e basear suas estratégias de
                marketing com a Organização controladora, conforme estas
                Políticas de Privacidade.
              </TextBody>
              <br />
              <TextBody size="bold">
              ...
              <TextBody>
                ...
                tratamento das informações que estes inserirem nas ferramentas
                de gestão.
                <br />
                <br />A Organização controladora se declara ciente que é a
                responsável pela segurança, tratamento e compartilhamento
                adequado dessas informações, não podendo realizar seu tratamento
                em desconformidade com a legislação vigente ou com estas
                Políticas de Privacidade, sob pena de responderem por todas as
                punições, em especial as de natureza cível, criminal e as
                aplicadas pela Autoridade Nacional de Proteção de Dados.
                <br />
                <br />
                Além disso, nós iremos compartilhar os dados pessoais dos
                Usuários apenas com as empresas referenciadas nestas políticas e
                internamente apenas com as pessoas estritamente necessárias para
                possibilitar a prestação do nosso serviço, como CEO, CPO,
                Customer Experience Head, Customer Success, Diretor de Negócios,
                Designers, Head, Head de People, Marketing e Tech Lead. Salvo
                nos casos citados, em caso de consentimento legal do titular dos
              ...
              <TextBody>
                ...
                Lei n. 12.965/2014, e artigo 7º, II, da Lei n. 13.709/18.
              </TextBody>
              <br />
              <TextBody size="bold">
              ...
              <TextBody>
                ...
                indireta via navegação e cookies para rastrear o número de IP,
              ...
              <TextBody>
                ...
                nossos canais de comunicação, principalmente pelo chat online da
                <Link href="https://www.portalintercom.org.br/" target="_blank">
                  &nbsp;Intercom
                </Link>
                , pois isso irá melhorar o seu atendimento e torná-lo mais
                eficiente. Sem esse histórico, provavelmente todas as vezes que
                você utilizasse a plataforma teria que repetir o que já nos
              ...
              <TextBody>
                ...
                corrigir os seus dados; tornar anônimo, bloquear ou eliminar os
                dados desnecessários, excessivos ou tratados em desconformidade
                com a Lei; pedir a portabilidade dos dados a outro fornecedor;
                eliminar dados, exceto aqueles exigidos por lei; obter
                informação sobre quem a <b>ATOS6</b> realizou uso compartilhado
                de dados; obter informação sobre a possibilidade de não fornecer
                consentimento e sobre as consequências da negativa; e voltar
                atrás e revogar o seu consentimento. Como o nosso serviço é
                prestado para as organizações controladoras e temos um contrato
                em vigor, é preciso que a empresa autorize alguma dessas ações
                antes que possamos atendê-las, ok?
              </TextBody>
              <br />
              <TextBody size="bold">
              ...
              <TextBody>
                ...
                <br />
                f) Cancelamento da Plataforma, de Contas de Acesso e Exclusão de
                Dados;
                <br />
                ...
                inscrita no CNPJ sob o nº 28.501.445/0001-74 com sede na Av. Rio
                ...
                fornecidos pelos Usuários Finais e está em conformidade com a
                Lei 12.965/2014 (Marco Civil da Internet) e com a Lei nº
                13.709/18 (Lei Geral de Proteção de Dados).
                <br />
                <br />
                Estas políticas de privacidade se referem apenas às Usuários
              ...
              <TextBody>
                2.1. Abaixo estão dispostos os significados das nomenclaturas
              ...
              <TextBody>
                ...
                dados pessoais são transferidos de forma criptografada e
                armazenados em servidores cloud (em nuvem) fornecidos pela{" "}
                <Link href="https://aws.amazon.com/pt/" target="_blank">
                  AWS Amazon
                </Link>{" "}
                ...
                , cujo acesso é restrito. Além disso, utilizamos criptografia
                TLS 1.2 e TSL 1.3 de ponta a ponta e uma variedade de
                tecnologias e procedimentos de segurança para ajudar a proteger
                as informações dos Usuários Finais.
              </TextBody>
              <TextBody>
                &nbsp;&nbsp;&nbsp;3.1.1. Essas empresas são independentes e não
                ...
                dessa plataforma e veja se concorda com todas as disposições,
                antes de utilizar nossos serviços.
              </TextBody>
              <TextBody>
                &nbsp;&nbsp;&nbsp;3.1.2. Para o processamento das informações
                referentes aos pagamentos, os seus dados serão enviados via API
                e trafegados pelas plataformas independentes&nbsp;
                <Link href="https://zoop.com.br/" target="_blank">
                  Zoop
                </Link>{" "}
                e a&nbsp;
                ...
                dos pagamentos. Nós não teremos acesso aos seus dados bancários
                e utilizamos essas plataformas terceirizadas para que eles
                possam garantir a segurança nas transações financeiras, já que
                sozinhos não conseguiríamos. Também recomendamos que você leia
                as{" "}
                <Link
              ...
              <TextBody>
                ...
                localizados fora do Brasil nos Estados Unidos, e têm o objetivo
                de prestar os serviços contratados de forma segura e eficaz.
              </TextBody>
              <br />
              <TextBody>
              ...
              <TextBody>
                ...
                controladora destes dados pessoais, ou seja, a quem compete as
                decisões referentes ao tratamento de dados pessoais. A{" "}
              ...
              <TextBody>
                ...
                coletamos sua localização e informações de forma indireta via
                navegação e cookies para rastrear o número de IP, localização,
                duração da visita e páginas visitadas, logs de acesso,
                identificador de dispositivo, Pixel Tag e outras informações
                coletadas pelo{" "}
                <Link
                  href="https://analytics.google.com/analytics/web/provision/#/provision"
                  target="_blank"
              ...
              <br />
              <TextBody>
                <u>4.3. Histórico de contato:</u> A ATOS6 armazena informações a
                respeito de todas as interações já realizadas entre os Usuários
                por meio da plataforma, como mensagens em e-mails, contatos
                telefônicos, upload de arquivos e chat online da{" "}
                <Link href="https://www.portalintercom.org.br/" target="_blank">
                  Intercon
                </Link>
                , pois isso irá melhorar o seu atendimento e torná-lo mais
              ...
              <TextBody>
                ...
                tipo de tratamento dos dados inseridos pelos Usuários Finais nas
                ferramentas de gestão utilizadas pela Organização controladora
                para finalidades próprias.
                <br />
                &nbsp;&nbsp;&nbsp;4.4.2. A <b>ATOS6</b>, em algumas situações,
                pode ser considerada controladora do tratamento, principalmente
                no que diz respeito aos dados coletados para prestar o serviço à
                Organização controladora, elaborar os contratos e basear suas
              ...
              <TextBody>
                ...
                Success, Diretor de Negócios, Designers, Head, Head de People,
                Marketing e Tech Lead.
              </TextBody>
              <br />
              <TextBody>
                5.2. Os dados dos Usuários serão compartilhados pela ATOS6 com
                as seguintes empresas e para as seguintes finalidades:
                <br />
                &nbsp;&nbsp;&nbsp;5.2.1.{" "}
                <Link href="https://aws.amazon.com/pt/" target="_blank">
                  AWS Amazon
                ...
                : uma vez que são responsáveis pela coleta indireta de dados;
                <br />
                &nbsp;&nbsp;&nbsp;5.2.8.{" "}
                <Link href="https://www.portalintercom.org.br/" target="_blank">
                  Intercom
                </Link>
                : uma vez que são responsáveis pelo armazenamento das conversas
                via chat on-line.
                <br />
                &nbsp;&nbsp;&nbsp;5.2.9. A partir do momento que estas empresas
                tiverem acesso a estes dados, se tornarão responsáveis pela
                ...
                de gestão.
                <br />
                &nbsp;&nbsp;&nbsp;5.3.1. A Organização controladora se declara
                ciente que é a responsável pela segurança, tratamento e
                ...
                Proteção de Dados. 5.4. Salvo nos casos citados, em caso de
                consentimento legal do titular dos dados pessoais e por força de
                ordem judicial ou determinação legal, nós não iremos
                compartilhar seus dados com terceiros.
                <br />
                <br />
                5.4. Salvo nos casos citados, em caso de consentimento legal do
                titular dos dados pessoais e por força de ordem judicial ou
                determinação legal, nós não iremos compartilhar seus dados com
                terceiros.
              </TextBody>
              <br />
              <TextBody size="bold">
              ...
              <TextBody>
                ...
                <b>ATOS6</b> poderá, a seu exclusivo critério, ou a pedido da
                Usuária Organização, bloquear, restringir, desabilitar ou
                impedir o acesso de qualquer Usuário à plataforma sempre que for
                detectada uma conduta inadequada.
              </TextBody>
              <br />
              <TextBody>
                6.2. Cancelamento de contas de acesso pelo Usuário Final: Os
                Usuários que queiram podem solicitar diretamente o cancelamento
                da conta (login) para a Organização controladora.
              </TextBody>
              <br />
              <TextBody>
                <u>
                  <b>
                    6.3. Exclusão de dados: No momento do cancelamento da conta,
              ...
              <TextBody>
                ...
                <br />
                &nbsp;&nbsp;&nbsp;7.1.3. Correção de dados incompletos, inexatos
                ou desatualizados;
                <br />
                &nbsp;&nbsp;&nbsp;7.1.4. Anonimização, bloqueio ou eliminação de
                dados desnecessários, excessivos ou tratados em desconformidade
                ...
                de dados;
                <br />
                &nbsp;&nbsp;&nbsp;7.1.8. Informação sobre a possibilidade de não
              ...
              <TextBody>
                ...
                do site, depois da divulgação, confirmará a vigência das novas
                Políticas de Privacidade pelos Usuários.
                <br />
                <br />
                ...
                <br />
                <br />
                9.3. Caso o Usuário não esteja de acordo com a alteração, poderá
                não fornecer consentimento para atos específicos ou poderá
                rescindir totalmente seu vínculo com a <b>ATOS6</b>. Essa
              ...
              <TextBody>
                10.1. A <b>ATOS6</b> indica como encarregado o Sr. Luiz Ribeiro
                Barbosa, com endereço eletrônico{" "}
                <Link href="mailto:luiz@raisesistemas.com.br" target="_blank">
                  luiz@raisesistemas.com.br
                </Link>
                , nos termos do art. 41 da Lei Geral de Proteção de Dados, para
                aceitar reclamações e comunicações dos titulares e da Autoridade
                Nacional de Proteção de Dados, prestar esclarecimentos e adotar
                providências.
              </TextBody>
              <br />
              <TextBody>
                10.2. A <b>ATOS6</b> dispõe de um texto específico para regular
              ...
              <TextBody>
                ...
                todas as comunicações que os Usuários desejarem fazer: pelo chat
                online disponível na plataforma, pelo e-mail{" "}
